...
./scripts_ksql/submit_wikipedia_irc_config.sh

echo -e "\nProvide data mapping to Elasticsearch:"
./scripts_ksql/set_elasticsearch_mapping_bot.sh
./scripts_ksql/set_elasticsearch_mapping_count.sh

echo -e "\nStart streaming to Elasticsearch sink connector:"
./scripts_ksql/submit_elastic_sink_config.sh
...
./scripts_ksql/listen_WIKIPEDIANOBOT.sh
./scripts_ksql/listen_EN_WIKIPEDIA_GT_1_COUNTS.sh
